...
export const criticalElementIds = [
  ...
  'magnifier-row-indicator-prev',
  'magnifier-row-indicator-current',
  'magnifier-row-indicator-next',
  'modal-magnifier-row-indicator-container',
  'modal-magnifier-row-indicator-prev',
  'modal-magnifier-row-indicator-current',
  'modal-magnifier-row-indicator-next',
...
export function getDOMElements() {
  const elements = {
    ...
    magnifierWrapper: document.getElementById(
      'magnifier-wrapper',
    ) as HTMLElement,
    magnifier: document.getElementById('magnifier') as HTMLElement,
    magnifierStallLayer: document.getElementById(
      'magnifier-stall-layer',
    ) as HTMLElement,
    magnifierRowIndicatorContainer: document.getElementById(
      'magnifier-row-indicator-container',
    ) as HTMLElement,
    magnifierRowIndicatorPrev: document.getElementById(
      'magnifier-row-indicator-prev',
    ) as HTMLElement,
    magnifierRowIndicatorCurrent: document.getElementById(
      'magnifier-row-indicator-current',
    ) as HTMLElement,
    magnifierRowIndicatorNext: document.getElementById(
      'magnifier-row-indicator-next',
    ) as HTMLElement,
    ...
    toggleMagnifierBtn: document.getElementById(
      'toggle-magnifier-btn',
    ) as HTMLElement,
    modalMagnifierWrapper: document.getElementById(
      'modal-magnifier-wrapper',
    ) as HTMLElement,
    modalMagnifier: document.getElementById('modal-magnifier') as HTMLElement,
    modalMagnifierStallLayer: document.getElementById(
      'modal-magnifier-stall-layer',
    ) as HTMLElement,
    modalMagnifierRowIndicatorContainer: document.getElementById(
      'modal-magnifier-row-indicator-container',
    ) as HTMLElement,
    modalMagnifierRowIndicatorPrev: document.getElementById(
      'modal-magnifier-row-indicator-prev',
    ) as HTMLElement,
    modalMagnifierRowIndicatorCurrent: document.getElementById(
      'modal-magnifier-row-indicator-current',
    ) as HTMLElement,
    modalMagnifierRowIndicatorNext: document.getElementById(
      'modal-magnifier-row-indicator-next',
    ) as HTMLElement,
    modalNavControls: document.getElementById(
      'modal-nav-controls',
    ) as HTMLElement,
    modalNavUp: document.getElementById('modal-nav-up') as HTMLButtonElement,
    modalNavDown: document.getElementById(
      'modal-nav-down',
    ) as HTMLButtonElement,
    modalNavLeft: document.getElementById(
      'modal-nav-left',
    ) as HTMLButtonElement,
    modalNavRight: document.getElementById(
      'modal-nav-right',
    ) as HTMLButtonElement,
    modalVerticalStallList: document.getElementById(
      'modal-vertical-stall-list',
    ) as HTMLElement,
    imageLightbox: document.getElementById('image-lightbox') as HTMLElement,
    imageLightboxClose: document.getElementById(
      'image-lightbox-close',
    ) as HTMLElement,
    imageLightboxImage: document.getElementById(
      'image-lightbox-image',
    ) as HTMLImageElement,
  };
  ...
  for (const key in elements) {
    if (!elements[key as keyof typeof elements]) {
      throw new Error(
        `Essential DOM element not found: #${key}. The application cannot start.`,
      );
    }
  }
